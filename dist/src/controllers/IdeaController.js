...
class IdeaController {
    ...
    async editIteration(req, res) {
        ...
        const updatedIdea = await this.ideaService.updateIteration(ideaId, parseInt(versionStr, 10), updates);
        // Format response
        const response = this.formatIdeaResponse(updatedIdea);
        res.json(response);
    }
     ...
     */
    formatIterationResponse(iteration) {
        return {
